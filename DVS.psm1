...
function Invoke-DCOMObjectScan {
    <#
        ...
        NOTE: The SkipProperyWithSameName flag might miss vulnerable functions when there is the same property name with different preferences(Methods/other properties) or different depth chain
        PS> Invoke-DCOMObjectScan -MaxDepth 4 -Type All  -FunctionListFile "C:\Users\USERNAME\Desktop\DVS\vulnerable.txt" -Hostlist "10.211.55.1/24" -SkipProperyWithSameName -Verbose
    #>
    [CmdletBinding(SupportsShouldProcess=$true)]
    param
    (
